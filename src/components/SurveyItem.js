  ...
  return (
    ...
    <div className="mb-2">
      <div className="flex justify-around pt-5 bg-white w-11/12 xl:w-8/12 mx-auto h-24 text-sm  text-gray-500 rounded-lg shadow-2xl dark:bg-slate-500 dark:text-slate-100">
        ...
        <div className="flex flex-col w-20 sm:28 md:w-24 text-center">
        ...
        <div
          className="border dark:border-slate-600 h-10 p-3 rounded-2xl hover:bg-red-200 hover:cursor-pointer hidden sm:block"
          id={survey._id}
          onClick={(e) => {
            deleteSurvey(e);
          }}
